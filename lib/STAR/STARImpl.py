...
https://github.com/alexdobin/STAR/blob/master/doc/STARmanual.pdf
    ...
    GIT_COMMIT_HASH = "88ae66b10e7dee8a4cb63d5810aed3aca5bfb1f7"
    ...
    def run_star(self, ctx, params):
        ...
        :returns: instance of type "AlignReadsResult" (Here is the definition
           ...
           generated by run_star report_name: report name generated by
           ...
           alignment_objs: list of reads and corresponding alignment created.
           ...
           reference exprMatrix_FPKM: generated FPKM ExpressionMatrix object
           reference exprMatrix_TPM_ref: generated TPM ExpressionMatrix
           object reference) -> structure: parameter "output_directory" of
           String, parameter "report_name" of String, parameter "report_ref"
           of String, parameter "alignmentset_ref" of String, parameter
           "alignment_objs" of mapping from type "obj_ref" (An X/Y/Z style
           reference) to type "AlignmentObj" (Created alignment object
           returned. ref = the workspace reference of the new alignment
           object name = the name of the new object, for convenience.) ->
           structure: parameter "ref" of type "obj_ref" (An X/Y/Z style
           reference), parameter "name" of String, parameter
           "expression_obj_ref" of type "obj_ref" (An X/Y/Z style reference),
           parameter "exprMatrix_FPKM_ref" of type "obj_ref" (An X/Y/Z style
           reference), parameter "exprMatrix_TPM_ref" of type "obj_ref" (An
