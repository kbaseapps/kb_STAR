...
/**
 * <p>Original spec-file type: STARalignParams</p>
 * <pre>
...
public class STARalignParams {
    ...
    public STARalignParams withAssemblyInputRef(String assemblyInputRef) {
        this.assemblyInputRef = assemblyInputRef;
        return this;
    }
    ...
    public STARalignParams withWorkspaceName(String workspaceName) {
        this.workspaceName = workspaceName;
        return this;
    }
    ...
    public STARalignParams withMinLength(Long minLength) {
        this.minLength = minLength;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("STARalignParams"+" [assemblyInputRef=")+ assemblyInputRef)+", workspaceName=")+ workspaceName)+", minLength=")+ minLength)+", additionalProperties=")+ additionalProperties)+"]");
    }
